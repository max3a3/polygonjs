...
import { PolySceneWithNodeMap_sphere_blink } from "./PolySceneWithNodeMap";
...
interface LoadedData {
  scene: PolySceneWithNodeMap_sphere_blink;
...
declare const loadSceneFromSceneData_sphere_blink: LoadSceneMethod;
